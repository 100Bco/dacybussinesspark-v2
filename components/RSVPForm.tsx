  ...
  return (
    <div className="w-full max-w-2xl mx-auto">
      <form className="space-y-12" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="pt-8">
          <button className="w-full bg-ink text-white py-6 hover:bg-alert transition-colors duration-500 group relative overflow-hidden shadow-2xl shadow-gray-200">
            <span className="relative z-10 flex items-center justify-between px-8 font-mono font-bold tracking-[0.2em] text-xs uppercase">
