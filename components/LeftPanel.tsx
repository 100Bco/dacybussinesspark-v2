  ...
  return (
    <div className="h-full flex flex-col justify-between p-4 md:p-6 lg:p-8 overflow-hidden bg-ink text-paper relative border-r border-gray-800">
      ...
      <div className="flex flex-col justify-center py-2">
         <p className="text-gray-500 font-mono text-[9px] md:text-[10px] uppercase tracking-[0.3em] mb-3 md:mb-4 pl-1">Event Countdown</p>
         ...
         <div className="flex flex-nowrap items-baseline gap-1 md:gap-1.5 lg:gap-2">
            ...
            <div className="flex flex-col items-center">
              <span className="text-3xl md:text-4xl lg:text-6xl font-mono font-medium tracking-tighter text-white leading-none">
            ...
            <span className="text-gray-700 font-thin text-2xl md:text-3xl lg:text-5xl leading-none self-start mt-1 opacity-50">:</span>
            ...
            {/* Seconds */}
            <div className="flex flex-col items-center">
              <span className="text-3xl md:text-4xl lg:text-6xl font-mono font-medium tracking-tighter text-white leading-none text-alert/90">
